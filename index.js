...
soundManager.registerSound({name:'whip-sound', src:'sounds/whip-sound.mp3'}, 0.1, 1);
soundManager.registerSound({name:'boss-hit', src:'sounds/hit.mp3'}, 0.3, 1);
soundManager.registerSound({name:'mainball-hit', src:'sounds/punch.mp3'}, 1, 1);
soundManager.registerSound({name:'lb-sfx', src:'sounds/lb-sfx.mp3'}, 0.2, 1);
